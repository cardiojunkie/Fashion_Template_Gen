...
def build_checklist() -> None:
    ...
    _checklist_sheet(
        ...
        [
            ...
            _row("NVIDIA-003", "Full connection", "Approved rotated NVIDIA_API_KEY is set.", "Generated 96x96 blue-square diagnostic", "Click Test NVIDIA Connection once.", "One request proves auth, fixed-model access, vision, and exact SGLang JSON-schema output shape=square/color=blue without product data."),
